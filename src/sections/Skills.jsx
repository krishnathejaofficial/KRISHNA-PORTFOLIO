...
export default function Skills() {
  ...
  const categories = [
    ...
    { icon: 'fa-tools', title: 'Programming & Tools', skills: [{ name: 'R', pct: 70 }, { name: 'HTML (Basic)', pct: 80 }, { name: 'VS Code / Figma', pct: 85 }, { name: 'Android Studio', pct: 80 }, { name: 'MS Office Suite', pct: 90 }, { name: 'Google Workspace', pct: 90 }, { name: 'Canva / Video Editing', pct: 85 }] },
  ];
