    ...
    <section id="experience" ref={ref}>
      ...
      <div className="timeline">
        <div className="timeline-item card" data-animate>
          <i className="fas fa-chart-line tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-shopping-cart tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-users tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-campground tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-microphone tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-microphone-alt tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-dna tl-icon" />
        ...
        <div className="timeline-item card" data-animate>
          <i className="fas fa-code tl-icon" />
